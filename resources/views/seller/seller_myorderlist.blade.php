...
function test(){
  ...
  $("input:checkbox[name=checkRow]:checked").each(function(index,elements)
  {
    ...
    console.log($('#'+index_no).parent().parent().children().children('.select').children('option:selected').parent("#id").id);


    // console.log($('#'+index_no).parent().parent().children().children('.select').children('option:selected').parent('#id'));
    // console.log($('#'+index_no).parent().parent().children().children('.select').children('option:selected').children('#id').val());
    //console.log($('#'+index_no).parent().parent().children().children('.select').children('option:selected').val());
