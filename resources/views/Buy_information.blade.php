        ...
        <div class="options">
          <div class="left">
            ...
            <div class="realcount">
              ...
              <button type="button" class="counts" id="minus{{$protb->p_no}}" name="button1" value="-" onclick="decrease({{$protb->p_no}});">
              <img class="countimg1" src="/imglib/remove.png" alt="">
            </button>
            <input class="count-plmi" type="text" name="amount{{$protb->p_no}}" onchange="change();" readonly id="pdcount{{$protb->p_no}}" value="1">
            <button type="button" class="counts" id="plus{{$protb->p_no}}" name="button2" value="+" onclick="increase({{$protb->p_no}});">
