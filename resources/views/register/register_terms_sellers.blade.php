      ...
      <form name="terms_agree"  action = '/register_seller' onsubmit="return checkform()">
        <div class="checkbox">
          <div class="checkbt">
            ...
            <div class="box">
              <textarea name="" id="">전자상거래(인터넷사이버몰) 표준약관
          ...
          <div class="checkbox">
            <div class="checkbt">
              ...
              <div class="box">
                <textarea name="" id="">정보통신망법 규정에 따라 꽃갈피에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
