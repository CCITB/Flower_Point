  ...
  <div id="all">
    ...
    <div class="signup">
      <form action = '/RegisterControllerSeller' method="post" name="registerform" onsubmit='return validatate();'>
        ...
        <label>비밀번호</label>
        <input class="inf1" type="password" placeholder="Password" name="s_password" id="new_pw"  >
        ...
        <div class="check_div" id="name" style="height:45px;" value=""></div>

        <label>연락처</label>
        <input class="inf1" type="text" placeholder="Phone Number" id="phonenum" name="s_phonenum" >
        <div class="check_div" id="phonenum" style="height:45px;" value=""></div>
        ...
        success : function(data) {
          ...
          //ID중복X
            ...
            //정규식 일치X
              ...
              $('#id_check').text("5~20자리의 영문 소문자와 특수기호 (-),(_)만 사용가능합니다.");
              $('#id_check').css('color', 'red');
            }
          }
