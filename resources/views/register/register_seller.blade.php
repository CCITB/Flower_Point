...
<body>
  <div id="all">
    ...
    <div class="signup">
      <form action = '/RegisterControllerSeller' method="post" name="registerform">
        @csrf
      ...
      <div class="under">
        ...
        <input class="lg_bt" id="btnSubmit" disabled="disabled" type='submit' value="다음" onsubmit="return check_all()" >
      </div>
    </form>
